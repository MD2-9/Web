...
var MdcMonet = (() => {
  ...
  // src/monet-mdc.js
  var monet_mdc_exports = {};
  __export(monet_mdc_exports, {
    MdcMonetEngine: () => MdcMonetEngine
  });
  ...
  var MdcMonetEngine = class {
    static generateTheme(colorInput, options = {}) {
      ...
      const dynamicScheme = new SchemeClass(primaryHct, isDark, 0);
  ...
  return __toCommonJS(monet_mdc_exports);
})();
